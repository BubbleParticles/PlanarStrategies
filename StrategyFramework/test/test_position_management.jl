...
mutable struct MockPositionStrategy
    ...
    function MockPositionStrategy()
        ...
        new(config, Dict{MockAssetInstance, Float64}(), 10000.0, 10000.0, Dict{Symbol, Any}())
    end
end

# Mock indicator values
function setup_mock_indicators!(s::MockPositionStrategy, ai::MockAssetInstance)
...
closeat(ai::MockAssetInstance, ats) = 50000.0  # Mock BTC price

# Mock the calculate_position_adjustment function
function calculate_position_adjustment(s::MockPositionStrategy, ai::MockAssetInstance, ats)
...
function get_target_position_size(s::MockPositionStrategy, ai::MockAssetInstance, ps::MockPositionSide, ats)
    tot = current_total(s)
    c = freecash(s)
...
function trade_amount(s::MockPositionStrategy, ai::MockAssetInstance, ats, ps::MockPositionSide)
...
@testset "Position Management Tests" begin
    ...
    @testset "calculate_position_adjustment function" begin
        ...
        adjustment_high_vol = calculate_position_adjustment(s, ai, ats)
    ...
    @testset "Position adjustment edge cases" begin
        ...
        adjustment_negative = calculate_position_adjustment(s, ai, ats)
        ...
        adjustment_nan = calculate_position_adjustment(s, ai, ats)
