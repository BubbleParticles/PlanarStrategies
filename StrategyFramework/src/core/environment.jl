...
- `assets::Vector{String}`: List of asset pairs (e.g., ["BTC/USDT", "ETH/USDT"])
"""
...
function get_current_assets()
    ...
    get_exchange_assets(flag, exchange)
end
...
function __init__()
    ...
    if isempty(ASSETS_CT)
        ...
        setassets!(:default, :phemex, ["BTC/USDT", "ETH/USDT"])
        setassets!(:default, :binance, ["BTC/USDT", "ETH/USDT"])
